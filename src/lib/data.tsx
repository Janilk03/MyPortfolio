...
export const caseStudies: CaseStudy[] = [
          ...
          <div className="prose prose-slate prose-lg max-w-none text-slate-600">
            ...
            <div className="mt-8 grid gap-8 sm:grid-cols-2">
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
                ...
                <p className="mb-0 text-base">Page layouts were dense, demanding unnecessary learning curves.</p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
                <h3 className="mt-0 font-semibold text-slate-900">2. Confusing Information Architecture</h3>
                <p className="mb-0 text-base">Key features were buried inside multi-level dropdowns and tabular patterns.</p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
                <h3 className="mt-0 font-semibold text-slate-900">3. High Learning Curve</h3>
                <p className="mb-0 text-base">Employees required detailed onboarding steps to complete simple updates.</p>
              </div>
              <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100">
                <h3 className="mt-0 font-semibold text-slate-900">4. Outdated Interaction Patterns</h3>
                <p className="mb-0 text-base">Relying heavily on manual dropdowns and fields instead of interactive and smart defaults.</p>
              </div>
            </div>
          </div>
        </section>
  ...
  },
  {
    ...
    heroImage: "/images/timesheet.jpeg",
    previewImages: [
